...
$(TARGET): $(MAIN_OBJ) $(TOP_OBJ) $(LIB_FILES) | $(BUILD_DIR)
	$(CC) $(CFLAGS) -o $@ $(MAIN_OBJ) $(TOP_OBJ) $(filter-out build/libdata_structures.a build/liblogger.a build/libcjson.a,$(LIB_FILES)) build/libdata_structures.a build/liblogger.a build/libcjson.a $(LIBS)
